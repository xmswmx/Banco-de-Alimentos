...
export class BeneficiarioGuard implements CanActivate {
 userLogged;
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
        ...
        if ((this.userLogged == null)||(this.userLogged.tipoDeUsuario != 'beneficiario')) {
            console.log('Loguea con un beneficiario para ingresar a esta página');
