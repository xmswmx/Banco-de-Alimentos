...
/**
 * Api services for the `DescripcionDetallada` model.
 */
@Injectable()
export class DescripcionDetalladaApi extends BaseLoopBackApi {
  ...
  /**
   * Buscar un elemento relacionado por id para productos.
   *
   * @param {any} id DescripcionDetallada id
   *
   * @param {any} fk Clave foránea para productos
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
  ...
  /**
   * Suprimir un elemento relacionado por id para productos.
   *
   * @param {any} id DescripcionDetallada id
   *
   * @param {any} fk Clave foránea para productos
  ...
  /**
   * Actualizar un elemento relacionado por id para productos.
   *
   * @param {any} id DescripcionDetallada id
   *
   * @param {any} fk Clave foránea para productos
  ...
  /**
   * productos consultas de DescripcionDetallada.
   *
   * @param {any} id DescripcionDetallada id
   *
   * @param {object} filter 
  ...
  /**
   * Suprime todos los productos de este modelo.
   *
   * @param {any} id DescripcionDetallada id
   *
   * @returns {object} An empty reference that will be
  ...
  /**
   * Recuentos productos de DescripcionDetallada.
   *
   * @param {any} id DescripcionDetallada id
   *
