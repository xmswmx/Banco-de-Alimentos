...
/**
 * Api services for the `Beneficiario` model.
 */
@Injectable()
export class BeneficiarioApi extends BaseLoopBackApi {
  ...
  /**
   * accessTokens consultas de Beneficiario.
   *
   * @param {any} id Beneficiario id
   *
   * @param {object} filter 
  ...
  /**
   * Recuentos accessTokens de Beneficiario.
   *
   * @param {any} id Beneficiario id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Beneficiarios/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.Beneficiario#getCurrent
   * @methodOf sdk.Beneficiario
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Beneficiarios" + "/:id";
   ...
   * call to {@link sdk.Beneficiario#login} or
   * {@link sdk.Beneficiario#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Beneficiario#login}
   *
  ...
  /**
   * @name sdk.Beneficiario#isAuthenticated
   *
  ...
  /**
   * @name sdk.Beneficiario#getCurrentId
   *
