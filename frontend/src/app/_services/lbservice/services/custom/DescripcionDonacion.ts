...
/**
 * Api services for the `DescripcionDonacion` model.
 */
@Injectable()
export class DescripcionDonacionApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id DescripcionDonacion id
   *
   ...
   * This usually means the response is a `DescripcionDonacion` object.)
   * </em>
   */
