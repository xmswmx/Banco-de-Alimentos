...
/**
 * Api services for the `DescripcionGeneral` model.
 */
@Injectable()
export class DescripcionGeneralApi extends BaseLoopBackApi {
  ...
  /**
   * Capta la relación hasOne volumenes.
   *
  ...
  /**
   * Crea una nueva instancia en volumenes de este modelo.
   *
   * @param {any} id DescripcionGeneral id
   *
  ...
  /**
   * Actualizar volumenes de este modelo.
   *
   * @param {any} id DescripcionGeneral id
   *
   * @param {object} data Request data.
  ...
  /**
   * Suprime volumenes de este modelo.
   *
   * @param {any} id DescripcionGeneral id
   *
   * @returns {object} An empty reference that will be
